              ...
              builder: (context, productsBox, _) {
                return ValueListenableBuilder(
                  ...
                  builder: (context, debtsBox, _) {
                    ...
                    final totalRevenue = allSales.fold(0.0, (s, x) => s + x.total);
                    final totalProfit = allSales.fold(0.0, (s, x) => s + x.profit);
                                    ...
                                    children: [
                                      Expanded(
                                        child: _QuickAction(
                                          ...
                                          color: AppColors.emerald,
                                          onTap: () {
                                            Provider.of<MainNavNotifier>(context, listen: false).goTo(2);
                                          },
                                        ),
                                      ),
                                      const SizedBox(width: 12),
                                      Expanded(
                                        child: _QuickAction(
                                          ...
                                          color: AppColors.navy,
                                          onTap: () {
                                            Provider.of<MainNavNotifier>(context, listen: false).goTo(1);
                                          },
                                        ),
                                      ),
                                    ],
                                    ...
                                    children: [
                                      Expanded(
                                        child: _QuickAction(
                                          ...
                                          color: AppColors.turquoise,
                                          onTap: () {
                                            Provider.of<MainNavNotifier>(context, listen: false).goTo(4);
                                          },
                                        ),
                                      ),
                                      const SizedBox(width: 12),
                            ...
                            SliverToBoxAdapter(
                              child: Padding(
                                ...
                                child: SectionHeader(
                                  ...
                                  trailing: TextButton(
                                    onPressed: () {
                                      Provider.of<MainNavNotifier>(context, listen: false).goTo(3);
                                    },
                            ...
                            SliverPadding(
                              ...
                              sliver: SliverList(
                                delegate: SliverChildBuilderDelegate(
                                  (context, index) {
                                    final sale = allSales[allSales.length - 1 - index];
                                    return _RecentSaleTile(sale: sale);
                                  },
                                  childCount: allSales.length > 4 ? 4 : allSales.length,
                                ),
                              ),
                            ),
                          ],
        ...
        children: [
          ...
          Row(
            children: [
              ...
              _HeroStat(label: 'Ingresos', value: formatMoneyCompact(totalRevenue)),
            ],
          ),
        ],
      ),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.receipt_long_outlined, color: AppColors.emerald, size: 20),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
